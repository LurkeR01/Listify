...
namespace Listify.Infrastructure.Migrations
{
    ...
    [Migration("20260408220600_AddedAvatarPropertiesToUserEntity")]
    partial class AddedAvatarPropertiesToUserEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Listify.Domain.Listing", b =>
                {
                    ...
                    b.OwnsOne("Listify.Domain.Location", "Location", b1 =>
                        {
